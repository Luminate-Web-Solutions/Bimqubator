...
app.use(cors({
  origin: ['https://bimqubator.com', 'https://bimqubator.com','https://wwww.bimqubator.com'],
  methods: ['GET', 'POST'],
}));
app.get('/', (req, res) => {
...
app.post('/contact', async (req, res) => {
  try {
    ...
    // Save to DB
    const savedContact = await Contact.create({ name, telephone, email, subject, message });
